...
<div  id="center">
<div  id="center-set" style="float:center;">
<p  align='center'  style="font-weight:bold;  font-size:35px;  font-family:Segoe  Print;  color:#3498DB;"> Code Utility Software</p>
<div class="fieldwrapper" style="align:center;"> 
...
<div class="btn-group" style=" display: inline;white-space: nowrap; margin-left: 350px;
    margin-right: auto;">
   <form action="" style="display: inline-block;
    text-align: center;" name="sear">
    <input name="stx" class="form-control" required="" type="text" size="55" maxlength="250" value="" itemname="search" style=" height: 40px;">
<!--    <input list="Units">-->
  <select form="sear" name="Units" style="height: 40px;">
      <option value="Class"> Class </option>
      <option value="DataType"> Data Type </option>
      <option value="Task" selected="selected"> Task </option>
      <option value="HeaderFile"> Header File </option>
      <option value="Randapa"> Randapa </option>
  </select>
    <input type="button" name="sbt" value="search" id="st-btn">
    </form>
</div>
